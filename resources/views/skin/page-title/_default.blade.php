@php
    ...
    $attr = array();
    if (theme()->getOption('skin', 'toolbar/fixed/desktop') === true && theme()->getOption('skin', 'toolbar/fixed/tablet-and-mobile') === true && theme()->getOption('skin', 'page-title/responsive') === true) {
...
<div {{ theme()->printHtmlAttributes("page-title") }} class="d-flex {{ $baseClass }}">
    ...
    @if (theme()->hasOption('page', 'description') && theme()->getOption('skin', 'page-title/description') === true)
        <!--begin::Separator-->
...
@if ( theme()->getOption('skin', 'page-title/breadcrumb') === true && !empty($breadcrumb))
    @if (theme()->getOption('skin', 'page-title/direction') === 'row')
        <!--begin::Separator-->
