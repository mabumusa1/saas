    ...
    <div class="d-flex flex-column">
        ...
        <div class="d-flex">
            ...
            <div class="flex-lg-row-auto ms-4">
               <a href="{{ route('installs.liveCheck', ['account' => $currentAccount, 'install' => $install, 'site' => $site]) }}" class="btn btn-primary">{{ __('See the checklist') }}</a>
            </div>
        </div>
        <!--end::Wrapper-->
        <!--begin::Close-->
                ...
                <div class="row">
                    <div class="col">
                        <p class="fw-bold">{{ __('Primary domain:') }} </span> <a
                                href="{{ route('domains.index', [$account, $site, $install]) }}">{{ __('Set primary domain') }}</a></p>
                        <p class="fw-bold">{{ __('Technical contact:') }} </span> <a
                                href="{{ route('contacts.edit', [$account, $install->contact]) }}">{{ $install->contact->fullName }}</a></p>
                    </div>
                    <div class="col">
