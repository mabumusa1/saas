...
<div class="card {{ $class }}">
    ...
    <div class="card-body p-0 d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center me-2">
                        ...
                        <div class="symbol symbol-50px me-3">
                            <div class="symbol-label bg-light-info">
                                {!! theme()->getSvgIcon("icons/duotone/Design/Color-profile.svg", "svg-icon-1 svg-icon-info"); !!}
                            </div>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <div class="d-flex align-items-center me-2">
                        ...
                        <div class="symbol symbol-50px me-3">
                            <div class="symbol-label bg-light-danger">
                                {!! theme()->getSvgIcon("icons/duotone/Home/Library.svg", "svg-icon-1 svg-icon-danger"); !!}
                            </div>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <div class="d-flex align-items-center me-2">
                        ...
                        <div class="symbol symbol-50px me-3">
                            <div class="symbol-label bg-light-success">
                                {!! theme()->getSvgIcon("icons/duotone/Shopping/Cart3.svg", "svg-icon-1 svg-icon-success"); !!}
                            </div>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <div class="d-flex align-items-center me-2">
                        ...
                        <div class="symbol symbol-50px me-3">
                            <div class="symbol-label bg-light-primary">
                                {!! theme()->getSvgIcon("icons/duotone/Shopping/Barcode-read.svg", "svg-icon-1 svg-icon-primary"); !!}
                            </div>
                        </div>
                        <!--end::Symbol-->
        ...
        <!--begin::Chart-->
        <div class="mixed-widget-6-chart card-rounded-bottom" data-kt-chart-color="{{ $chartCcolor }}" style="height: {{ $chartHeight }}"></div>
        <!--end::Chart-->
    </div>
    <!--end::Body-->
</div>
