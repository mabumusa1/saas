<?php
    ...
    $listRows = array(
        array(
            'icon' => 'icons/duotone/Home/Globe.svg',
            'title' => 'Sales',
        ...
        array(
            'icon' => 'icons/duotone/Layout/Layout-4-blocks-2.svg',
            'title' => 'Revenue',
        ...
        array(
            'icon' => 'icons/duotone/Devices/Watch2.svg',
            'title' => 'Growth',
            'description' => '80% Rate',
            'stats' => '$8,8m',
            'arrow' => 'up'
        ...
        array(
            'icon' => 'icons/duotone/General/Clipboard.svg',
            'title' => 'Dispute',
                ...
                <div class="d-flex align-items-center {{ util()->putIf(next($listRows), 'mb-6') }}">
                    ...
                    <div class="d-flex align-items-center flex-wrap w-100">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            @if($row['arrow'] === 'up')
                                {!! theme()->getSvgIcon("icons/duotone/Navigation/Arrow-up.svg", "svg-icon-5 svg-icon-success ms-1") !!}
                            @else
                                {!! theme()->getSvgIcon("icons/duotone/Navigation/Arrow-down.svg", "svg-icon-5 svg-icon-danger ms-1") !!}
                            @endif
                        </div>
                        <!--end::Label-->
                    </div>
