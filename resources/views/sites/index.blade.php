                    ...
                    <div class="col-5 mb-4">
                        <h5 class="text-muted">Search for site, domain, environment</h4>
                            <form class="input-group mb-3">
                                <input type="text" class="form-control border-right-0" name="q" value="{{ request()->get('q') }}"/>
                                <span class="input-group-text bg-transparent " id="basic-addon2"><i class="bi bi-search"></i></span>
                              </form>
                    </div>
