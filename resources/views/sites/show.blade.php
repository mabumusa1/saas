        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="alert alert-dismissible bg-light-primary d-flex flex-column flex-sm-row p-5 mb-10">
                    <!--begin::Icon-->
                    <span class="svg-icon svg-icon-2hx svg-icon-dark me-4 mb-5 mb-sm-0"><svg width="24px" height="24px"
                            ...
                            <path
                                ...
                                id="Oval-53" fill="#000000" fill-rule="nonzero" opacity="0.3"></path>
                            <path
                                d="M22.5,21 L19.5,21 C19.5,12.163444 11.836556,4.5 3,4.5 L3,1.5 C13.4934102,1.5 22.5,10.5065898 22.5,21 Z"
                                id="Oval-53-Copy" fill="#000000" fill-rule="nonzero" opacity="0.3"></path>
                        </svg></span>
                    <!--end::Icon-->
                        ...
                        <button class="btn btn-primary btn-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                    ...
                                    <g id="Stockholm-icons-/-Files-/-Cloud-download" stroke="none" stroke-width="1"
                        ...
                        <button class="btn btn-primary btn-icon">
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                ...
                                <path
                                    ...
                                    id="Mask" fill="#fff"></path>
                            </svg>
                        </button>
                        <button class="btn btn-primary btn-icon">
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g id="Stockholm-icons-/-General-/-Trash" stroke="none" stroke-width="1" fill="none"
                                    fill-rule="evenodd">
                                    <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                    <path
                                        d="M6,8 L6,20.5 C6,21.3284271 6.67157288,22 7.5,22 L16.5,22 C17.3284271,22 18,21.3284271 18,20.5 L18,8 L6,8 Z"
                                        id="round" fill="#fff" fill-rule="nonzero"></path>
                                    <path
