<div class="card card-bordered mb-5">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-6">
                <!--begin::Option-->
                <input type="radio" class="btn-check" name="type" value="prd" id="radioPrd" autocomplete="off" checked>
            ...
            <div class="col-6">
                <!--begin::Option-->
                <input type="radio" class="btn-check"  name="type" value="dev" id="radioDev" autocomplete="off">
