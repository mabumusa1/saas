<div class="card card-bordered mb-5">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <div class="mb-10">
                    ...
                    <input type="text" name="sitename" value="{{ old('sitename') }}" id="siteName" class="form-control fv-row" placeholder="{{ __('Site Name') }}"/>
                </div>
                <!--end::Input group-->
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
                ...
                <div class="mb-10">
                    <div class="input-group">
                        <input type="text" name="installname" id="installName" class="w-50 form-control" placeholder="{{ __('Install Name') }}" aria-label="{{ __('Install Name') }}" aria-describedby="installNameLabel" value="{{ old('installname') }}"/>
        ...
        <div class="row">
            <div class="col-6">
                <!--begin::Option-->
                <input @if(!$currentAccount->hasPaymentMethod()) disabled @endif type="radio" class="btn-check" name="type" value="prd" id="radioPrd" autocomplete="off" >
            ...
            <div class="col-6">
                <!--begin::Option-->
                <input @if(!$currentAccount->hasPaymentMethod()) checked @endif type="radio" class="btn-check"  name="type" value="dev" id="radioDev" autocomplete="off">
